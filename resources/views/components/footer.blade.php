    ...
    <div class="mx-auto max-w-screen-xl">
        <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
                <a href="#" class="flex items-center">
                    <img src="{{ asset('storage/Goblog-4.png') }}"class="mr-5 h-12" alt="GoBlog Logo" />
                    <span class="self-center text-2xl font-semibold text-white">GoBlog</span>
                </a>
            </div>
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <div>
                    ...
                    <ul class="text-gray-400">
                        ...
                        <li><a href="/posts" class="hover:underline">Blog</a></li>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <div class="flex flex-col sm:flex-row justify-center items-center gap-2">
                <p class="text-sm text-gray-400 sm:text-center">© 2025 <a href="#" class="hover:underline">GoBlog™</a>. All Rights Reserved</p>
                <span class="hidden text-gray-400 sm:block">|</span>
                <p class="text-sm text-gray-400 sm:text-center">Built by <a href="https://github.com/AldyAlfnsyh" class="hover:underline">AldyAlfnsyh</a></p>
            </div>
