<x-layout>
    ...
    <x-slot:header_title>{{$header_title}}</x-slot>
      ...
      <div class="container px-6 py-12 max-w-7xl mx-auto sm:px-6 lg:px-8">
          <div>
          ...
          <div class="grid grid-cols-1 gap-12 mt-10 md:grid-cols-2 lg:grid-cols-3">
              <div>
                  ...
                  <p class="mt-2 text-blue-500 ">goblog@gmail.com</p>
              </div>
              ...
              <div>
                  ...
                  <p class="mt-2 text-blue-500 ">+62 (555) 000-0000</p>
              </div>
          </div>
      </div>
